...
for (i in 1:length(tracking.frame$jerseyNumber)) {
  if ((tracking.frame$jerseyNumber[i] < 50) & (tracking.frame$offense[i] == T) & (min(tracking.frame$dBall[tracking.frame$dBall > 0])) | (tracking.frame$jerseyNumber[i] > 79) & (tracking.frame$offense[i] == T) & (tracking.frame$dBall[i] > min(tracking.frame$dBall[tracking.frame$dBall > 0]))) {
